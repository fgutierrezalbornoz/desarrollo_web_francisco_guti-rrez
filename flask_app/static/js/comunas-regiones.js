...
// Función para cargar comunas y regiones desde flask
// const filtraComunas = async () => {
//   const regionSelect = document.getElementById("region-select");
//   const comunaSelect = document.getElementById("comuna-select");
//   comunaSelect.innerHTML = '<option value="">--Escoge una comuna--</option>';
//   const response = await fetch(`/comunas/${regionSelect.value}`);
//   const comunasFlask = await response.json()

//   if (regionSelect.value){
//     comunasFlask.forEach(comuna => {
//       let optionComuna = document.createElement("option");
//       optionComuna.value = comuna.id;
//       optionComuna.textContent = comuna.nombre;
...
const regionSelect = document.getElementById("region-select");
const cargaRegiones = () => {
  regionComunas['regiones'].forEach(region => {
...
const filtraComunas = () =>{
  ...
  comunaSelect.innerHTML = '<option value="">--Escoge una comuna--</option>';
  if (regionSelect.value){
    const comunasRegionSelect = regionComunas['regiones'].find(r => r.numero.toString() === regionSelect.value)["comunas"];
